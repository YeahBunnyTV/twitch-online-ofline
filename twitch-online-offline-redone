...
(function (document, $script) {
  ...
  var attribute = $script.attr("data-attribute") || "data-twitch-channel",
      ...
      onlineImage = $script.attr("data-online-image") || 'data:image/svg+xml,<?xml version="1.0"?><svg height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"><circle cx="3" cy="3" r="8" fill="green"/></svg>',
      offlineImage = $script.attr("data-offline-image") || 'data:image/svg+xml,<?xml version="1.0"?><svg height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"><circle cx="3" cy="3" r="8" fill="red"/></svg>',
